...
\fb{the bibfile is missing.}
	...
	The work by Sanders et al. considers agents who have these same assumptions, but learn with a
	reduced version of the Experience Weighted Attraction algorithm. For the Reinforcement Learning
	community, it is of interest to consider the question of stability from the point of view of
	agents who follow the popular Q-Learning algorithm.
...
>>>>>>> 6b8af9307b1d139a91fd15c6c8a0e3d509ee12a2
\end{align}
...
The behaviour of this line for $\omega = 0$ gives the long term behaviour of the system. By considering that, for a stable fixed point to exist, $\left<[|\mathcal{X}(\omega = 0)|^2 \right>$, we arrive at an expression for a stability line (i.e. the phase transition between the existence of stable fixed points and unstable behaviour).
