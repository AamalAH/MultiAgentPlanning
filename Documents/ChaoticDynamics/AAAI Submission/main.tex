...
% affiliations
% use superscripts in text and roman font to identify them. For example, Sunil Issar,\textqsuperscript{\rm 2} J. Scott Penberthy\textsuperscript{\rm 3} George Ferguson,\textsuperscript{\rm 4} Hans Guesgen\textsuperscript{\rm 5}. Note that the comma should be placed BEFORE the superscript for optimum readability
...
Behaviours' \fb{maybe italics?} which considers the evolution of agent strategies as they
...
\subsection{Dynamical Behaviours}
 ...
 This segment of research aims to achieve a deeper understanding
    ...
    It has long been established \fb{add refs?} that, upon lifting the strong
...
as they iteratively play a game.  Through this, they were able to
    ...
    \ref{fig::TuylsExperiments} \fb{discuss limitations as well}.
