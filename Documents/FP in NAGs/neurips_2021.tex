...
%
  ...
  dynamics in games with many players, as shownin \cite{Sanders2018}.
...
multi-player games
are decomposed
%by requiring that each agent engage
...
%Our work
%adapts this model to consider NA Games,
...
\subsection{Assumptions}
  ...
  \begin{assumption}\label{ass::sameactions}
    ...
    most game0theoretic settings and includes \fb{?}, as a special
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\answerYes{All contributions stated in the abstract are included in Sections 3-5 of the paper.}
		\item Did you describe the limitations of your work?
		\answerYes{Sec. 2.3 discusses the assumptions placed on the theoretical results, as well as their implications. We provide numerical simulations to provide insight into the behaviour when some of these assumptions are lifted}
		\item Did you discuss any potential negative societal impacts of your work?
		\answerYes{In Sec. 5, we caution against the over-reliance of convergence in learning algorithms and provide experiments to show that this will not always be the case.}
	...
	\begin{enumerate}
		...
		\answerYes{Full Proofs, as well as the arguments used to derive them, are provided in the Supplementary Material}
	\end{enumerate}
	
	\item If you ran experiments...
	\begin{enumerate}
		\item Did you include the code, data, and instructions needed to reproduce the main experimental results (either in the supplemental material or as a URL)?
		\answerYes{Code is provided in the supplementary material}
		\item Did you specify all the training details (e.g., data splits, hyperparameters, how they were chosen)?
		\answerYes{We provide explanations as to the choice for our range of strength of noise in Sec 5.2.}
		\item Did you report error bars (e.g., with respect to the random seed after running experiments multiple times)?
		\answerNA{Our experiments do not concern statistical results but are rather illustrative of the behaviour of a deterministic algorithm}
