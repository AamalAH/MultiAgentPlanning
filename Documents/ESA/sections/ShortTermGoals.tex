...
\fr{perhaps we can provide a bit more of context. Also, we can refer to the appendix for the details of the derivation and mention that we are aiming for a submission to AAAI.}
    ...
    algorithm \cite{?}, which is seen to be a strong \fr{why?} representation of how
    ...
    \fr{differences/similarities between EWA and Q-learning?}
     ...
     We begin with the equations as described by Tuyls et al \cite{Tuyls2006AnGames} \fr{describing \ldots}
    ...
    correlation across payoff elements. Taking this average \fr{some more details?} yields
%
    \begin{equation}
    \begin{split}
